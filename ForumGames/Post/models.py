...
class Post(models.Model):
    ...
    videogames_id = models.ForeignKey(PossVideogames, db_column="name",on_delete=models.PROTECT, blank=True, null=True, default="")
    computer_id = models.ForeignKey(ComponentsComputer, db_column="Com_ID_num", on_delete=models.CASCADE, null=True, default="Computer")
